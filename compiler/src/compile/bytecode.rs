...
pub(crate) fn compile(instrs: Vec<super::Instruction>) -> Vec<u8> {
    ...
    let instrs = instrs.into_iter().fold(Vec::new(), |mut instrs, instr| {
        match instr {
            ...
            super::Instruction::And => instrs.push(vm::Instruction::And.code()),
            super::Instruction::Or => instrs.push(vm::Instruction::Or.code()),
            super::Instruction::Not => instrs.push(vm::Instruction::Not.code()),
            super::Instruction::Le => instrs.push(vm::Instruction::Le.code()),
            super::Instruction::Ge => instrs.push(vm::Instruction::Ge.code()),
            super::Instruction::Lt => instrs.push(vm::Instruction::Lt.code()),
            super::Instruction::Gt => instrs.push(vm::Instruction::Gt.code()),
